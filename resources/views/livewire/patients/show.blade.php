        ...
        <div class="flex items-start gap-4">
            ...
            @if ($canManage)
                <a href="{{ route('pipeline', ['novo' => $patient->id]) }}" wire:navigate
                    class="flex flex-shrink-0 items-center gap-1.5 rounded-xl border border-teal-200 bg-teal-50 px-3 py-2 text-sm font-medium text-teal-700 transition-colors hover:bg-teal-100">
