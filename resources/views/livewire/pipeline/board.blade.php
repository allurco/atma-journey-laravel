        ...
        <div class="flex min-w-max gap-4">
            @foreach ($columns as $column)
                ...
                <div class="flex w-72 flex-shrink-0 flex-col overflow-hidden rounded-xl border border-slate-200 bg-white">
                    ...
                    <div class="max-h-[calc(100vh-300px)] space-y-2 overflow-y-auto p-2.5">
                        @forelse ($column['cards'] as $card)
                            <div class="rounded-lg border border-slate-200 p-3 transition-all duration-200 hover:shadow-md" wire:key="card-{{ $card->id }}">
