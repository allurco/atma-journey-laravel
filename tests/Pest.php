...
pest()->extend(TenantTestCase::class)
    ...
    ->in('Feature/Auth', 'Feature/Settings', 'Feature/Patients', 'Feature/Pipeline', 'Feature/Scheduling', 'Feature/Financial', 'Feature/Clinical', 'Feature/Leads', 'Feature/Layout', 'Feature/Doctor');
